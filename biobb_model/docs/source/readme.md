...
* Installation:
        ...
        conda install -c bioconda "biobb_model>=3.5.1"
...
* Installation:
        ...
        docker pull quay.io/biocontainers/biobb_model:3.5.1--py_0


* Usage:


        docker run quay.io/biocontainers/biobb_model:3.5.1--py_0 <command>
