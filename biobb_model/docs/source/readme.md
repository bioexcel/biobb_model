...
* Installation:
        ...
        conda install -c bioconda "biobb_model>=3.0.0"
...
* Installation:
        ...
        docker pull quay.io/biocontainers/biobb_model:3.0.0--py_0


* Usage:


        docker run quay.io/biocontainers/biobb_model:3.0.0--py_0 <command>
