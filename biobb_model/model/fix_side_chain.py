...
class FixSideChain:
    ...
    Args:
        ...
        output_pdb_path (str): Output PDB file path. File type: output. `Sample file <https://github.com/bioexcel/biobb_model/blob/master/biobb_model/test/reference/model/output_pdb_path.pdb>`_. Accepted formats: pdb.
        properties (dic):
