...
class Check():
    ...
    def __init__(self, input_file_path, output_file_path, properties, **kwargs):
        ...
        self.command = properties.get('command', 'chains')
        self.command_options = properties.get('command_options', '--select all')
    ...
    def launch(self):
        ...
        instructions = ['--non_interactive', '--force_save', '--rename_terms']
...
def main():
    ...
    Check(input_file_path=args.input_file_path,  
